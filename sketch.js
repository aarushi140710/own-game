...
function preload(){
    // customers
    customer1Img = loadImage("customers/customer1.png");
    customer2Img = loadImage("customers/customer2.png");
    customer3Img = loadImage("customers/customer3.png");
    customer4Img = loadImage("customers/customer4.png");
    customer5Img = loadImage("customers/customer5.png");
    customer6Img = loadImage("customers/customer6.png");
    customer7Img = loadImage("customers/customer7.png");
    customer8Img = loadImage("customers/customer8.png");

    // restaurant
    resortImg = loadImage("restaurant/resort.png");
    tabletopImg = loadImage("restaurant/tabletop.jpg");
    chefImg = loadImage("restaurant/chef.png");
    cheeseandcornImg = loadImage("restaurant/cheese and corn pizza.png");
    deluxeveggieImg = loadImage("restaurant/deluxe veggie pizza.png");
    farmhouseImg = loadImage("restaurant/farmhouse pizza.png");
    margheritaImg = loadImage("restaurant/margherita pizza.png");
    paneertikkaImg = loadImage("restaurant/paneer tika pizza.png");
    paneermakhaniImg = loadImage("restaurant/paneer makhani pizza.png");
    peppypaneerImg = loadImage("restaurant/peppy paneer pizza.png");
